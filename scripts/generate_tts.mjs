...
const LINES = [
  ...
  ["clue-5", "비밀번호는 삼백십오입니다. 듣고 한국어로 말하세요.", "ko-KR-Standard-A"],
  ...
  ["clue-13", "거실 문은 냉장고 옆에 있어요.", "ko-KR-Standard-B"],
  ...
  ["try-again", "따라 해 보세요. 삼백십오.", "ko-KR-Standard-A"],
  ["success", "축하합니다. 집 밖으로 탈출했습니다.", "ko-KR-Standard-C"],
];
const REFRESH = new Set(["clue-3", "clue-5", "clue-6", "clue-16", "success"]);
